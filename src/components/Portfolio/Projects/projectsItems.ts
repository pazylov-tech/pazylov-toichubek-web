export const projectsItems = [
  {
    ...
    features: [
      ...
      'Smooth animated transitions using AOS.',
      'Navigation optimized for user experience.',
      'Built with modern stack: React, Vite, TypeScript, TailwindCSS.',
      'Showcasing experience, education, tech stack, and my side projects.',
    ],
  },
  {
    title: 'SOLO',
    ...
    features: [
      'Concept app inspired by the anime "Solo Leveling".',
      'Gamified interface simulating progress, training, and quests.',
      'Creative exercise in UI components, animation, and dark-themed design.',
      'Themed dashboard mimicking in-anime "System" logic.',
      'Practice project focusing on imagination and UI storytelling.',
    ],
  },
  {
    title: 'ReadMeet',
    ...
    features: [
      'User profiles built around books, authors, and reading interests.',
      'Matchmaking system to connect like-minded readers.',
  ...
  },
  {
    ...
    features: [
      'Real-time unit conversions with instant feedback.',
      'Supports multiple categories: length, mass, temperature, and more.',
      'Mobile-first, responsive layout with clean UI.',
      'Optimized input validation and dropdown handling.',
      'Ideal for everyday users and students alike.',
    ],
  },
  {
    title: 'Go',
    ...
    features: [
      'Contributed to responsive layout and frontend architecture.',
      'Improved visual hierarchy for better UX.',
      'Collaboration with design lead and dev team.',
      'Production-ready deployment quality.',
      'Supported a real organization: Kyrgyz Go Federation.',
    ],
  },
];
